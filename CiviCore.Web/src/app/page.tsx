                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 reveal">
                        <div className="bg-surface dark:bg-primary-container rounded-2xl shadow-sm border border-border-subtle/50 dark:border-primary-container/50 overflow-hidden hover:shadow-md transition-shadow group">
                            ...
                            <div className="p-6">
                                ...
                                <div className="mt-auto border-t border-border-subtle/50 dark:border-primary-container/50 pt-4 flex justify-between items-center">
                                    <Link className="text-primary dark:text-primary-fixed-dim font-label-md inline-flex items-center group/link" href="/events/1">
                        ...
                        <div className="bg-surface dark:bg-primary-container rounded-2xl shadow-sm border border-border-subtle/50 dark:border-primary-container/50 overflow-hidden hover:shadow-md transition-shadow group">
                            ...
                            <div className="p-6">
                                ...
                                <div className="mt-auto border-t border-border-subtle/50 dark:border-primary-container/50 pt-4 flex justify-between items-center">
                                    <Link className="text-primary dark:text-primary-fixed-dim font-label-md inline-flex items-center group/link" href="/events/2">
                                        <span className="group-hover/link:underline">View Details</span> 
                                        <span className="material-symbols-outlined text-sm ml-1 group-hover/link:translate-x-1 transition-transform">arrow_right_alt</span>
                                    </Link>
                                </div>
                        ...
                        <div className="bg-surface dark:bg-primary-container rounded-2xl shadow-sm border border-border-subtle/50 dark:border-primary-container/50 overflow-hidden hover:shadow-md transition-shadow group">
                            ...
                            <div className="p-6">
                                ...
                                <div className="mt-auto border-t border-border-subtle/50 dark:border-primary-container/50 pt-4 flex justify-between items-center">
                                    <Link className="text-primary dark:text-primary-fixed-dim font-label-md inline-flex items-center group/link" href="/events/3">
                                        <span className="group-hover/link:underline">View Details</span> 
                                        <span className="material-symbols-outlined text-sm ml-1 group-hover/link:translate-x-1 transition-transform">arrow_right_alt</span>
                                    </Link>
                                </div>
                ...
                <section className="py-section-gap bg-surface-container-low dark:bg-primary-container/20 px-margin-mobile md:px-margin-desktop" id="gallery">
                    <div className="max-w-container-max mx-auto">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 h-auto md:h-[600px]">
                            <Link href="/gallery/clubhouse" className="block rounded-2xl overflow-hidden relative group reveal shadow-sm border border-border-subtle/50 dark:border-primary-container/50 h-[300px] md:h-full">
                            ...
                            <div className="flex flex-col md:grid md:grid-rows-2 gap-6 h-auto md:h-full">
                                <Link href="/gallery/community-life" className="block rounded-2xl overflow-hidden relative group reveal shadow-sm border border-border-subtle/50 dark:border-primary-container/50 h-[300px] md:h-full" style={{ transitionDelay: '0.1s' }}>
                                ...
                                <Link href="/gallery/clubhouse" className="block rounded-2xl overflow-hidden relative group reveal shadow-sm border border-border-subtle/50 dark:border-primary-container/50 h-[300px] md:h-full" style={{ transitionDelay: '0.2s' }}>
                ...
                <section className="py-section-gap px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto" id="bulletins">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 reveal">
                        <div className="bg-surface dark:bg-primary-container rounded-2xl p-6 shadow-sm border border-border-subtle/50 dark:border-primary-container/50">
                            ...
                            <Link className="text-[#b45309] dark:text-[#d97706] font-label-md hover:underline" href="/buletin/1">Read Full Bulletin</Link>
                        </div>
                        <div className="bg-surface dark:bg-primary-container rounded-2xl p-6 shadow-sm border border-border-subtle/50 dark:border-primary-container/50">
                            ...
                            <Link className="text-[#b45309] dark:text-[#d97706] font-label-md hover:underline" href="/buletin/2">Read Full Bulletin</Link>
                        </div>
                        <div className="bg-surface dark:bg-primary-container rounded-2xl p-6 shadow-sm border border-border-subtle/50 dark:border-primary-container/50">
                            ...
                            <Link className="text-[#b45309] dark:text-[#d97706] font-label-md hover:underline" href="/buletin/3">Read Full Bulletin</Link>
                        </div>
                    </div>
                </section>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 reveal">
                            ...
                            <div className="bg-surface dark:bg-primary-container rounded-2xl shadow-sm border border-border-subtle/50 dark:border-primary-container/50 overflow-hidden flex flex-col group">
                                ...
                                <div className="p-6 flex flex-col flex-grow">
                                    ...
                                    <Link href="/property/2" className="mt-auto block text-center w-full py-3 border-2 border-primary dark:border-primary-fixed-dim text-primary dark:text-primary-fixed-dim rounded-lg hover:bg-primary hover:text-white dark:hover:bg-primary-fixed-dim dark:hover:text-primary transition-colors font-label-md">View Details</Link>
                                </div>
                            </div>
                            {/* Property 3 */}
                            <div className="bg-surface dark:bg-primary-container rounded-2xl shadow-sm border border-border-subtle/50 dark:border-primary-container/50 overflow-hidden flex flex-col group">
                                ...
                                <div className="p-6 flex flex-col flex-grow">
                                    ...
                                    <Link href="/property/3" className="mt-auto block text-center w-full py-3 border-2 border-primary dark:border-primary-fixed-dim text-primary dark:text-primary-fixed-dim rounded-lg hover:bg-primary hover:text-white dark:hover:bg-primary-fixed-dim dark:hover:text-primary transition-colors font-label-md">View Details</Link>
                                </div>
                            </div>
                        </div>
                    </div>
