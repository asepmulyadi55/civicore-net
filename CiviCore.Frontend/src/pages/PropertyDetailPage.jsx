...
function SkeletonDetail({ isDark }) {
                                            ...
                                            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                                                ...
                                                {listing.land_area && (
                                                    <div className="flex flex-col items-center gap-1 rounded-xl py-3" style={{ background: C.surfaceVar }}>
                                                        ...
                                                        <span className="text-lg font-bold" style={{ color: C.primary, fontFamily: "'Plus Jakarta Sans', sans-serif" }}>{Math.round(listing.land_area)}<span className="text-xs font-normal">m²</span></span>
                                                ...
                                                {listing.building_area && (
                                                    <div className="flex flex-col items-center gap-1 rounded-xl py-3" style={{ background: C.surfaceVar }}>
                                                        ...
                                                        <span className="text-lg font-bold" style={{ color: C.primary, fontFamily: "'Plus Jakarta Sans', sans-serif" }}>{Math.round(listing.building_area)}<span className="text-xs font-normal">m²</span></span>
