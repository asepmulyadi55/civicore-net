            ...
            <main className="flex-grow pt-32 pb-section-gap px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto w-full">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {MOCK_ALBUMS.map(album => (
                        <Link to={`/gallery/${album.id}`} key={album.id} className="group relative rounded-2xl overflow-hidden h-[400px] shadow-sm hover:shadow-xl border border-border-subtle/50 dark:border-primary-container/50 transition-shadow">
